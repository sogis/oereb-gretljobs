...
WHERE 
    (
        ...
        AND 
        artcodeliste = 'urn:fdc:ilismeta.interlis.ch:2020:Typ_geschuetztes_Geotop_Flaeche'
    )
;
...
WHERE 
    (
        thema = 'ch.SO.Einzelschutz'
        AND 
        artcodeliste = 'urn:fdc:ilismeta.interlis.ch:2020:Typ_geschuetztes_Geotop_Punkt'
    )
;
