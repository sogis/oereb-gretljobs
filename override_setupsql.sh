...
cat /pgconf/setup_original.sql /pgconf/set_role.sql /pgconf/transfer_arp_npl_oereb_gdi.sql /pgconf/transfer_afu_grundwasserschutz_oereb_gdi.sql > /pgconf/setup.sql
