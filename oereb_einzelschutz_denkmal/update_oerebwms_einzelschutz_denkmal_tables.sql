...
DELETE FROM ${dbSchema}.oerebwms_einzelschutz_flaeche;
INSERT INTO ${dbSchema}.oerebwms_einzelschutz_flaeche
...
AND
    eigentumsbeschraenkung.weiteresthema = 'geschütztes historisches Kulturdenkmal'
AND
...
DELETE FROM ${dbSchema}.oerebwms_einzelschutz_punkt;
INSERT INTO ${dbSchema}.oerebwms_einzelschutz_punkt
WITH RECURSIVE x(ursprung, hinweis, parents, last_ursprung, depth) AS 
(
    SELECT 
        ursprung, 
