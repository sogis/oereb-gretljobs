...
WHERE 
    (
        ...
        AND 
        artcodeliste = 'urn:fdc:ilismeta.interlis.ch:2019:Typ_geschuetztes_historisches_Kulturdenkmal_Flaeche'
    )
;
...
DELETE FROM 
    ${dbSchema}.so_g_rb0220222wms_einzelschutz_punkt
WHERE 
    (
        thema = 'ch.SO.Einzelschutz'
        AND 
        artcodeliste = 'urn:fdc:ilismeta.interlis.ch:2019:Typ_geschuetztes_historisches_Kulturdenkmal_Punkt'
    )
;
