...
INSERT INTO
    ...
    SELECT
        ...
        'kantonal' AS artcode,
        'urn:fdc:ilismeta.interlis.ch:2020:Typ_Kanton_Naturschutzgebiete' AS artcodeliste,
        'inKraft' AS rechtsstatus,
        teilgebiet.publiziertab,
        amt.t_id AS zustaendigestelle
    FROM
        arp_naturreservate.reservate_teilgebiet AS teilgebiet
        LEFT JOIN arp_naturreservate.reservate_reservat AS reservat
        ON reservat.t_id = teilgebiet.reservat
...
INSERT INTO
    ...
    INNER JOIN arp_naturreservate_oereb.vorschriften_dokument AS vorschriften_dokument
       ...
       -- AND reservate_dokument.rechtsvorschrift IS TRUE AND reservate_dokument.rechtsstatus= 'inKraft'
...
order by eigentumsbeschraenkung
;
...
INSERT INTO
    ...
    SELECT
        ...
        ST_MakeValid(ST_RemoveRepeatedPoints(ST_SnapToGrid(gis_geometrie.apolygon, 0.001))) AS flaeche_lv95,
        teilgebiet_geometrie.rechtsstatus,
        teilgebiet_geometrie.publiziertab,
    ...
    FROM
        ...
        INNER JOIN arp_naturreservate_oereb.transferstruktur_eigentumsbeschraenkung AS eigentumsbeschraenkung
        ON teilgebiet_geometrie = eigentumsbeschraenkung.t_id,
         (
             SELECT
                 basket.t_id AS basket_t_id,
                 dataset.datasetname AS datasetname
