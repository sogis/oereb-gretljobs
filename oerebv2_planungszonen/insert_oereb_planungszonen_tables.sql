...
(
    ...
    FROM
        arp_planungszonen_oerebv2.transferstruktur_darstellungsdienst AS darstellungsdienst
        LEFT JOIN arp_planungszonen_oerebv2.transferstruktur_eigentumsbeschraenkung AS eigentumsbeschrankung
...
(
    SELECT 
        muri.t_id
    FROM 
        arp_planungszonen_oerebv2.multilingualuri AS muri
...
(
    SELECT 
        luri.t_id
    FROM 
        arp_planungszonen_oerebv2.localiseduri AS luri
...
(
    DELETE FROM 
        arp_planungszonen_oerebv2.multilingualuri m 
    WHERE 
        t_id IN 
        (
            SELECT 
